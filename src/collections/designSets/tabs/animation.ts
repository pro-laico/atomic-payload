        ...
        fields: [
          {
            ...
            fields: [
              ...
              APField({ type: 'text', apf: ['classes'], name: 'duration', required: true, admin: { description: ds.duration } }),
              APField({ type: 'text', apf: ['classes'], name: 'timingFns', required: true, admin: { description: ds.timingFns } }),
              APField({ type: 'text', apf: ['classes'], name: 'properties', required: true, admin: { description: ds.properties } }),
              APField({ type: 'text', apf: ['classes'], name: 'counts', required: true, admin: { description: ds.counts } }),
              APField({ type: 'text', apf: ['classes'], name: 'ease', required: true, admin: { description: ds.ease } }),
            ],
