...
export interface IconSetCollectionOptions {
   ...
   * consumers using `ap-atomic-hook`'s plugin factory can attach it that way.
   */
            ...
            fields: [
              {
                name: 'iconsArray',
                type: 'array',
                admin: { initCollapsed: true, components: { RowLabel: '@pro-laico/ap-icons/admin/iconRowLabel' } },
                fields: [
                  {
                    type: 'row',
                    fields: [
