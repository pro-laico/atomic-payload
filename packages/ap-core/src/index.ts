...
// /////////////////////////////////////
export const APFControlsPath = '@pro-laico/ap-core/admin/controls'
export const APFieldPath = '@pro-laico/ap-core/admin/field'
export const APFieldLabelPath = '@pro-laico/ap-core/admin/label'
export const SiteTriggersPath = '@pro-laico/ap-core/ui/root/siteTriggers'
export const SlugPath = '@pro-laico/ap-core/ui/fields/slug'
