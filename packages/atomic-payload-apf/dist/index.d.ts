...
export declare const APFControlsPath = "@pro-laico/atomic-payload-apf/admin/controls";
export declare const APFieldPath = "@pro-laico/atomic-payload-apf/admin/field";
export declare const APFieldLabelPath = "@pro-laico/atomic-payload-apf/admin/label";
