...
const d = {
  ...
  whenInView: 'Default is false. If true, the video will only load when it is in view.',
          ...
          fields: [
            ...
            },
            {
              ...
              fields: [
                ...
                { name: 'whenInView', type: 'checkbox', label: 'Load when in view?', admin: { width: '20%', description: d.whenInView } },
