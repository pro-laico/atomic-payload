...
async function revalidateGlobalBySlug(slug: string, draft: boolean): Promise<void> {
  switch (slug) {
    case 'siteMetaData':
 ...
 */
export const revalidateCacheAfterChange: GlobalAfterChangeHook = async ({ global, doc, context }) => {
