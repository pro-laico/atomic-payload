 ...
 * `@pro-laico/core` here. The `@pro-laico/icons` cache getters (used by the
 * `Icon` component) then reach the Local API via that registry without importing
 * `@payload-config` from package source.
 */
