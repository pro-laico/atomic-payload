...
import type { APFieldType, APArgs, APReturn } from '@pro-laico/atomic-payload-types'

const APFieldPath = '@pro-laico/atomic-payload-apf/admin/field'
const APFieldLabelPath = '@pro-laico/atomic-payload-apf/admin/label'
