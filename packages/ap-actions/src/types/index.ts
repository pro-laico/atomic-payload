...
import type { AtomicStore } from '@pro-laico/ap-atomic-hook'
...
// subpath so names like `ActionBlockType` (type) don't collide with the
// value-namespace `ActionBlockType` (zod schema) exported from the package
// root.
