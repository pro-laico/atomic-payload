/**
 * `@pro-laico/ap-core` barrel — merged surface of the former ap-types,
 ...
 *   `@pro-laico/ap-core/logger` and `@pro-laico/ap-core/cache` on the server.
 *
 ...
 *   from `@pro-laico/ap-core/auth/getMeUser` on the frontend when needed.
 */
export * from './kernel';
...
export declare const APFControlsPath = "@pro-laico/ap-core/admin/controls";
export declare const APFieldPath = "@pro-laico/ap-core/admin/field";
export declare const APFieldLabelPath = "@pro-laico/ap-core/admin/label";
export declare const SiteTriggersPath = "@pro-laico/ap-core/ui/root/siteTriggers";
export declare const SlugPath = "@pro-laico/ap-core/ui/fields/slug";
