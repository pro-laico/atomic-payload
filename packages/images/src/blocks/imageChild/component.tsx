...
export const ImageChild: React.FC<RenderChild<ImageChildType>> = async (props) => {
  ...
  // `@pro-laico/core/cache/auto` is bound to the config the host app registered via `registerPayloadConfig`, so this component only works inside a Next.js app that registers it at startup.
