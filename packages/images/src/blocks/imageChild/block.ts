...
const d = {
  ...
  alt: 'Defaults to the alt set on the image asset; add an instance-specific alt here. Leave blank only for decorative images — non-decorative images need alt text for accessibility.',
