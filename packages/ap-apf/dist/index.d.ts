...
export declare const APFControlsPath = "@pro-laico/ap-apf/admin/controls";
export declare const APFieldPath = "@pro-laico/ap-apf/admin/field";
export declare const APFieldLabelPath = "@pro-laico/ap-apf/admin/label";
